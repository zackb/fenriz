...
// Vertical stripes `stripe` px wide. Blur flattens fine stripes to their average, so a striped
// backdrop makes "has anything been drawn over this pixel?" answerable anywhere on it.
